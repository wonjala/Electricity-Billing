...
<!--        <-- End Search Icon-->
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="${pageContext.request.contextPath}/PageChange?page=addUser">
      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="${pageContext.request.contextPath}/AddServlet?page=addUser" method="post" novalidate>
                <div class="col-md-12">
                  <label for="username" class="form-label">Full name</label>
                  <input type="text" class="form-control" id="name" placeholder="Full name" name="username" value="" required>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="address" id="Address" placeholder="Location"  value="" required>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-12">
                    <label for="Scno" class="form-label"> SCNO. </label>
                    <input type="text" class="form-control" name="scno" id="name" placeholder="Service connection no." value="" required>
                    <div class="valid-feedback">
                      Looks good!
                    </div>
                    <div class="invalid-feedback">
                        Please provide service connection no.
                      </div>
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="password" class="form-control" name="password" id="password" placeholder="Password" value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                    <div class="valid-feedback">
                      Looks good!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-12">
                  ...
                  <button class="btn btn-primary" name="button" value="register" type="submit">Submit</button>
                </div>
