<%-- 
    ...
    Created on : Apr 6, 2023, 5:06:29 PM
    Author     : DELL
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <main id="main">
            ...
            <section class="forgotpass" style="background-image: url(assets/img/bg.png); height: 80vh">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="text-center">
                                                ...
                                                <p>Enter your new password to change password and login.</p>
                                                <div class="panel-body">

                                                    <form action="AddServlet?page=ResetPassword" method="post">
                                                         <div class="col-md-12">
                                                        <label for="NewPassword">New Password</label>
                                                        <input required type="password" placeholder="New password" name="NewPassword" id="NewPassword" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="password" required />
                                                         </div>
                                                        <br>
                                                         <div class="col-md-12">
                                                        <label for="ConfirmPassword">Confirm Password</label>
                                                        <input required type="password" placeholder="Confirm password" name="ConfirmPassword" id="ConfirmPassword" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="password" required/>
                                                         </div>
                                                        <br>
