        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="${pageContext.request.contextPath}/PageChange?page=payments">Payments</a></li>
            ...
            <section class="section dashboard">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">View Unpaid Bill Details</h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <c:forEach items="${unpaylist}" var="user">
                                ...
                                <td data-label="Payment">
                                    <form action="CalcBill?page=paybill" method="post">
                                        ...
                                        <button type="submit" class="btn btn-primary">Paid</button></form>
                                </td>
                                        </c:forEach>
