<%-- 
    Document   : AdminLogin
    Created on : Mar 7, 2023, 9:22:41 AM
    Author     : DELL
--%>
        ...
        <div class="container">
            ...
            <div class="mid-container">
                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/loginServlet?page=existing" method="post">
                    <div id="lol" style="color: red; font-size: 20px">
                    <%=session.getAttribute("err")%>
                    </div>
                        <!-- Subject ID -->
                        <div class="an-input-field">
                            <label for="adminId">Username</label>
                            <input type="text" id="adminId" name="username" placeholder="Enter Username" required>
                        </div>
                        <!-- Password field -->
                        <div class="an-input-field">
                     ...
                     <script>
    var i=document.getElementById("lol").style;
    setTimeout(function(){
        i.display="none";
    },2000);
