              ...
              <tbody>
                      <c:forEach items="${userList}" var="user">
                                            ...
                                            <tr>
                                                ...
                                                <td>${user.scno}</td> 
                                                <td>
                                                    <button class="btn btn-primary" name="userID" value="update"> <a href=" PageChange?page=update&id=${user.id}"> Update </a>   </button>

                                                </td>
                                                <td>
<!--                                                    <button class="btn btn-danger"> <a href=" AddServlet?page=deleteUser&id=${user.id}"> Delete </a> </button>-->
<!--                                                     Vertically centered Modal 
-->                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#verticalycentered"  onclick="document.getElementById('delete').value ='${user.id}'" class="delete">
                                                        Delete              </button>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="AddServlet?page=deleteUser" method="post">
